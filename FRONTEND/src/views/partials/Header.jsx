                    ...
                    <div className="collapse navbar-collapse" id="navbarCollapse">
                        ...
                        <ul className="navbar-nav navbar-nav-scroll ms-auto">
                            ...
                            <li className="nav-item">
                                {isLoggedIn() ? (
                                    <>
                                        <Link to={"/dashboard/"} className="btn btn-dark" href="dashboard.html">
                                            Dashboard <i className="bi bi-grid-fill"></i>
                                        </Link>
                                        <Link to={"/logout/"} className="btn btn-dark ms-2" href="dashboard.html">
                                            Logout <i className="fas fa-sign-out-alt"></i>
                                        </Link>
                                    </>
                                ) : (
                                    <>
                                        <Link to={"/register/"} className="btn btn-dark" href="register.html">
                                            Register <i className="fas fa-user-plus"></i>
                                        </Link>
                                        <Link to={"/login/"} className="btn btn-dark ms-2" href="dashboard.html">
