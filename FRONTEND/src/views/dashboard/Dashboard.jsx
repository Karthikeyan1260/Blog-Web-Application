                                                ...
                                                <div className="col-12" key = {Index}>
                                                    <div className="d-flex align-items-center position-relative">
                                                        <div className="avatar avatar-lg flex-shrink-0">
                                                            <img className="avatar-img" src= {posts.profile?.image} 
                                                        ...
                                                        <div className="d-flex justify-content-between position-relative">
                                                            <div className="d-sm-flex">
                                                                ...
                                                                <div className="ms-0 ms-sm-3 mt-2 mt-sm-0">
                                                                    <h6 className="mb-0">{noti.type}</h6>
                                                                    <p className="mb-0">
                                                                        {n.type === "Like" && (
                                                                            <p>
                                                                                Someone liked your post <b>{noti.post.title?.slice(0, 30) + "..."}</b>
                                                                            </p>
                                                                        )}
                                                                        {n.type === "Comment" && (
                                                                            <p>
                                                                                You have a new comment on <b>{noti.post?.title?.slice(0, 30) + "..."}</b>
                                                                            </p>
                                                                        )}
                                                                        {n.type === "Bookmark" && (
                                                                            <p>
                                                                                Someone bookmarked your post <b>{noti.post?.title?.slice(0, 30) + "..."}</b>
                                                                            </p>
                                                                        )}
                                                                    </p>
                                                                    <span className="small">5 min ago</span>
                                                                    <br />
                                                                    <button onClick={() => handleMarkNotiAsSeen(noti.id)} className="btn btn-secondary mt-2">
                                        ...
                                        <table className="table align-middle p-4 mb-0 table-hover table-shrink">
                                            ...
                                            <tbody className="border-top-0">
                                                {posts?.map((post, Index) => (
                                                    <tr>
                                                        <td>
                                                            <h6 className="mt-2 mt-md-0 mb-0" key = {Index}>
                                                        ...
                                                        <td>
                                                            <span className="badge bg-dark bg-opacity-10 text-dark mb-2">{post.status}</span>
                                                        </td>
                                                        <td>
